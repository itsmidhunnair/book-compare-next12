...
export default function Home() {
  ...
  return (
    <>
      <HtmlLangTitle title="Quick Books" description="Meta description for homepage" />
        ...
        <div className="container mx-auto flex flex-col-reverse items-center px-7 py-24 max-sm:pt-5 md:flex-row">
          <div className="mb-16 flex flex-col items-center text-center md:mb-0 md:w-1/2 md:items-start md:pr-16 md:text-left lg:flex-grow lg:pr-24">
            ...
            <p className="mb-8 leading-relaxed text-gray-600 dark:text-gray-300">
              ...
              Look no further!{" "}
              <span className="font-medium italic">Quick Books</span> is here to
              save the day and transform your reading experience. Whether
              you&apos;re a bookworm, a casual reader, or simply curious about
              the literary world, our app is designed to help you discover,
              explore, and find your next favorite book in a matter of seconds.
              Get ready to embark on an exciting reading journey with{" "}
